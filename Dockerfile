...
ARG PYTHON_VERSION
ARG HIVE_TAG_SUFFIX
FROM dsaidgovsg/spark-custom-addons:${BASE_VERSION}_${SPARK_VERSION}_scala-${SCALA_VERSION}_hadoop-${HADOOP_VERSION}_python-${PYTHON_VERSION}${HIVE_TAG_SUFFIX}_pyspark_debian
